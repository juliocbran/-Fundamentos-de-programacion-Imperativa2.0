...
def pedidos(ventaTotal=0):
    ...
    # Caso Base: Si elige 0 se termina la recursividad y muestra el total
    if opcion == 0:
        print("\n=============================")
        print(f" ¡Gracias por tu compra!\n Total a pagar: ${ventaTotal} dolares")
        print("=============================")
        return ventaTotal
    # Opción 1: Suma Vainilla y se llama a sí misma con el nuevo total
    elif opcion == 1:
        nuevoTotal = ventaTotal + vainilla
        print(f"-> Añadido Vainilla. Subtotal: ${nuevoTotal} dolares")
        return pedidos(nuevoTotal)
    # Opción 2: Suma Chocolate y se llama a sí misma con el nuevo total
    elif opcion == 2:
        nuevoTotal = ventaTotal + chocolate
        print(f"-> Añadido Chocolate. Subtotal: ${nuevoTotal} dolares")
        return pedidos(nuevoTotal)
    # Opción Inválida: Se llama a sí misma conservando el total actual
    else:
